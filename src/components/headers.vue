...
<script>
	...
	export default {
		props: ["title", "status", "only","offerStatus","shopOrderId","back","isGoHome","vinCode","jumpType","offerVin"],
		name: 'headers',
		mixins: [commonMixin],
		data: function() {
			return {
...
<style>
	...
	.returnLink {
		width:1.28rem;
		height: 1.16rem;
		background: url(../assets/images/headers/return.png) no-repeat center left;
	...
	.homeLink {
		width: 1.12rem;
		height: 1.16rem;
		background: url(../assets/images/headers/icon_home_w.png) no-repeat center center;
	...
	.aa-vinSearchBox span .searchContainer .keyValue {
		...
		border-radius: .1rem;
		font-size: .373rem;
		background: #fff1f2 url(../assets/images/headers/down.png) no-repeat right center;
	...
	.aa-vinSearchBox span a.aa-searchLink {
		background: url(../assets/images/headers/icon_query.png) no-repeat center center;
		background-size: .48rem;
	}
